  ...
  return (
    <div className='w-full h-full flex flex-col'>
        <div id="heading" className="w-full h-fit space-y-2 lg:px-[140px] px-4 my-20 flex flex-col">
            <h1 className="tracking-tight font-semibold items-center lg:text-[64px] whitespace-nowrap text-3xl leading-[1]">Revolutionize Engagement</h1>
            <h1 className="font-denton w-fit tracking-tight lg:translate-y-2 translate-y-1 colorshadowbox2 colorgrad rounded-md px-2 py-2.5 font-semibold items-center lg:text-[64px] text-3xl leading-[1]">One Click at a Time</h1>
            <p className="text-white/80 tracking-tight lg:text-2xl text-base lg:pt-5 pt-3">Empowering Your Social Media Strategy with AI</p>
        </div>
                ...
                <SwiperSlide className="lg:!w-[400px] !w-[300px] ">
                    <div id='card1' className="z-[2] overflow-hidden w-full h-full border-2 border-[#333] bg-gradient-to-r from-[#010101] via-[#131313] to-[#010101] flex flex-col px-6 pl-9 pt-10">
                        <div id="iconhead" className="capitalize flex gap-2 text-base font-semibold  py-2 items-center">
                            ...
                            <p className=" font-denton text-white/80 lg:text-2xl text-lg lg:h-8 h-6 ">AI-Driven Insights</p>
                        </div>
                        <div id="title" className=" z-[1]  lg:text-4xl text-2xl font-bold tracking-tight leading-[1.25] mt-5">Smarter decisions with AI</div>
                ...
                <SwiperSlide className="lg:!w-[400px] !w-[300px]">
                    <div id='card2' className="z-[2] overflow-hidden w-full h-full border-2 border-[#333] bg-gradient-to-r from-[#010101] via-[#131313] to-[#010101] flex flex-col px-6 pl-9 pt-10">
                        <div id="iconhead" className="capitalize flex gap-2 text-base font-semibold  py-2 items-center">
                            ...
                            <p className=" font-denton text-white/80 lg:text-2xl text-lg lg:h-8 h-6 ">Real-Time Performance</p>
                        </div>
                        <div id="title" className=" z-[1]  lg:text-4xl text-2xl font-bold tracking-tight leading-[1.25] mt-5">Analyze metrics instantly</div>
                        <div className=" z-[1] capitalize flex gap-2 w-fit tracking-tight border border-[#333] bg-black/30 backdrop-blur-md font-semibold lg:px-6 px-4 lg:py-4 py-3 mt-5 ">
                            <p className="uppercase tracking-wider lg:text-base text-xs lg:translate-y-0 translate-y-0.5 ">Know More</p>
                            <Image src="/assets/rightarrow.svg" alt="Insights" width={20} height={20} />
                        </div>
                ...
                <SwiperSlide className="lg:!w-[400px] !w-[300px]">
                    <div id='card3' className="z-[2] overflow-hidden w-full h-full border-2 border-[#333] bg-gradient-to-r from-[#010101] via-[#131313] to-[#010101] flex flex-col px-6 pl-9 pt-10">
                        <div id="iconhead" className="capitalize flex gap-2 text-base font-semibold  py-2 items-center">
                            ...
                            <p className=" font-denton text-white/80 lg:text-2xl text-lg lg:h-8 h-6 ">Seamless AI Integration</p>
                        </div>
                        <div id="title" className=" z-[1]  lg:text-4xl text-2xl font-bold tracking-tight leading-[1.25] mt-5">AI tools for better outcomes</div>
                        <div className=" z-[1] capitalize flex gap-2 w-fit tracking-tight border border-[#333] bg-black/30 backdrop-blur-md font-semibold lg:px-6 px-4 lg:py-4 py-3 mt-5 ">
                            <p className="uppercase tracking-wider lg:text-base text-xs lg:translate-y-0 translate-y-0.5 ">Know More</p>
                            <Image src="/assets/rightarrow.svg" alt="Insights" width={20} height={20} />
                        </div>
                ...
                <SwiperSlide className="lg:!w-[400px] !w-[300px]">
                    <div id='card4' className="z-[2] overflow-hidden w-full h-full border-2 border-[#333] bg-gradient-to-r from-[#010101] via-[#131313] to-[#010101] flex flex-col px-6 pl-9 pt-10">
                        <div id="iconhead" className="capitalize flex gap-2 text-base font-semibold  py-2 items-center">
                            ...
                            <p className=" font-denton text-white/80 lg:text-2xl text-lg lg:h-8 h-6 ">User-Friendly Workflow</p>
                        </div>
                        <div id="title" className=" z-[1]  lg:text-4xl text-2xl font-bold tracking-tight leading-[1.25] mt-5">Simplify analysis visually</div>
                        <div className=" z-[1] capitalize flex gap-2 w-fit tracking-tight border border-[#333] bg-black/30 backdrop-blur-md font-semibold lg:px-6 px-4 lg:py-4 py-3 mt-5 ">
                            <p className="uppercase tracking-wider lg:text-base text-xs lg:translate-y-0 translate-y-0.5 ">Know More</p>
                            <Image src="/assets/rightarrow.svg" alt="Insights" width={20} height={20} />
                        </div>
